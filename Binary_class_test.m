...
% %%
% para.tol=1e-4;
% para.tolfactor_res=100; %% %%调节tau的大小 （100）括号内为上版测试取值
% para.tolfactor_x=10; % (10)
% para.tolfactormin=10; %(10)
% para.delta=0.5e-4;
% 
% if strcmp(para.ker,'Lin')==1 
%     para.speed=2;    %要快一点可改为3； %(2)
%     para.speedmax=3;  %% speed_max 越大后期越快 (2)
%     para.Fmin_permit=2;  %(4)(2) %主要调这个
% else   
%     para.tolfactor_res=10; %% %%调节tau的大小 （100）括号内为上版测试取值
%     para.speed=3;  
%     para.speedmax=4;  
